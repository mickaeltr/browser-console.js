(function () {
    ...
    console.readConfig = function (config) {
        ...
        console.config.disableGlobalErrorsLogging = window.$.trim(console.config.disableGlobalErrorsLogging) === "true";
    ...
    console.handleGlobalErrorsLogging = function () {
        if (console.config.disableGlobalErrorsLogging) {
            ...
            if (window.$.isFunction(window.onerror) && window.onerror !== console.onError) {
                console.log("window.onerror will be overriden; you can prevent this by setting 'disableGlobalErrorsLogging' to true");
            }
    ...
    console.restore = function () {
        ...
        console.readConfig({
            disableGlobalErrorsLogging: true,
            levels: [],
            serverUrl: "X"
        });
